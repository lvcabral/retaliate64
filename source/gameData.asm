...
gDLSkip
                ...
                lda GAMEDATA + 3
                cmp #PlayerMaxModels
                bcs gDLPlayer   ; Ignore if is invalid index (corrupted file?)
                sta playerFrameIndex
gDLPlayer       lda GAMEDATA + 4
                beq gDLShield   ; Ignore if color is black (corrupted file?)
                sta shipColorIndex
gDLShield       lda GAMEDATA + 5
                beq gDLSfx      ; Ignore if color is black (corrupted file?)
                sta shldColorIndex
gDLSfx          lda GAMEDATA + 6
